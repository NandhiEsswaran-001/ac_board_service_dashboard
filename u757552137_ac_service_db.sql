...
--
-- Host: localhost    Database: u757552137_ac_service_db
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `board_services`;
...
CREATE TABLE `board_services` (
  ...
  CONSTRAINT `board_services_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
/*!40000 ALTER TABLE `board_services` DISABLE KEYS */;
INSERT INTO `board_services` VALUES
...
(4,'Kumar','9677317513','123gandipuran','Lg','124','','','Display PCB, Room Sensor-ID, Coil Sensor-OD','',1000.00,0.00,'','In Process','Pending',0.00,'',1,'2026-03-27 07:34:30','2026-03-27 07:34:51'),
...
(11,'Ravi thomas','9790555422','Arul Ac service \r\nHope college \r\nCoimbatore','Lg','EBR74149620','CH44 error','Error CH44','Compressor Jack, Indoor PCB, Outdoor PCB, Display PCB, Dis Sensor-OD, Room Sensor-ID, Coil Sensor-OD, Coil Sensor-ID, AMB Sensor-OD','Ok',1500.00,0.00,'','Completed','Pending',0.00,'',1,'2026-04-07 10:48:26','2026-04-07 10:49:35'),
(12,'Hidhayuthulla','7502950667','Karumbukadai \r\nCoimbatore','Voltas','El00','E1 error','Communication problem','Indoor PCB, Outdoor PCB, Display PCB, Room Sensor-ID, Back Cover-OD, Coil Sensor-ID, Transformer','',1500.00,0.00,'','Completed','Pending',0.00,'',1,'2026-04-07 11:44:46','2026-04-07 11:45:46'),
(13,'Alwar','8190935314','Arun ac service \r\nKannappa nagar \r\nCoimbatore','Daikin','Ex13025-48(D)','Compressor not working','Compressor not working','Indoor PCB, Outdoor PCB, Display PCB, Dis Sensor-OD, Room Sensor-ID, Coil Sensor-OD, Back Cover-OD, Coil Sensor-ID, AMB Sensor-OD','',1500.00,0.00,NULL,'Pending','Pending',0.00,NULL,1,'2026-04-07 11:48:36','2026-04-07 11:48:36');
/*!40000 ALTER TABLE `board_services` ENABLE KEYS */;
COMMIT;
...
CREATE TABLE `field_services` (
  ...
  KEY `created_by` (`created_by`),
  CONSTRAINT `field_services_ibfk_1` FOREIGN KEY (`assigned_employee`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `field_services_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
INSERT INTO `field_services` VALUES
...
--
-- Dumping routines for database 'u757552137_ac_service_db'
--
...
-- Dump completed on 2026-04-10 11:24:52
